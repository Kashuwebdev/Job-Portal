...
const MyJobs = () => {
    ...
    return (
        <div className='max-w-screen-2xl container mx-auto xl:px:24 px-24'>
            <div className='my-jobs-container bg-amber-600'>
                <h1 className='text-center p-5 font-serif text-white font-extrabold text-4xl'>All My Jobs</h1>
                <div className='p-2 text-center mb-2'>
                    <input
                        onChange={(e) => setSearchText(e.target.value)}
                        type="text" name="search" id="search" className='py-2 pl-3 border focus:outline-none lg:w-6/12 mb-4w-full' />
            ...
            {/* table */}
            <section className="py-1 bg-amber-600">
                <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-5">
                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                        ...
                        <div className="block w-full overflow-x-auto font-bold">
                            <table className="items-center text-4xl  bg-transparent w-full border-collapse ">
                                <thead>
                                    <tr>
                                ...
                                {
                                    isLoading ? (<div className='flex items-center justify-center h-5'><p>loading...</p></div>) : (<tbody>
                                        {
                                            currentJobs.map((job, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                        ...
                                                        <button onClick={() => handleDelete(job._id)} className='bg-red-600 py-2 px-6 text-white'>Delete</button>
                                                    </td>
                                                </tr>
                ...
                <div className='flex justify-center text-white space-x-8 mb-8'>
                    {
                        currentPage > 1 && (
