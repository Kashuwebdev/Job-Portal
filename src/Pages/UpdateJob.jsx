...
const UpdateJob = () => {
    const { id } = useParams();
    const { _id, jobTitle, maxPrice, minPrice, companyName, salaryType, jobLocation, postingDate, experienceLevel, companyLogo, employmentType, description, postedBy, skills }
        = useLoaderData();
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="w-full">
                        ...
                        <textarea className="w-full py-1.5 pl-3 text-black focus:outline-none" rows={10}
                            ...
                            defaultValue={description} {...register("description")} />
