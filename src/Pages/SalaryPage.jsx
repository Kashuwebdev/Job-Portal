...
const SalaryPage = () => {
    ...
    return (
        <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
            <PageHeader title={"Estimate Stipend"} path={"Salary"} />
            ...
            <div className='mt-5'>
                <div className='search-box p-2 text-center mb-2'>
                    ...
                    <button onClick={handleSearch} className='bg-blue-600 text-white font-bold  px-8 py-2 rounded-sm mb-4'>Search</button>
            ...
            <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-12 my-12 items-center'>
                {
                    salary.map((data) => (
                        <div key={data.id} className='shadow px-4 py-8 bg-amber-500'>
                            <h4 className='font-bold text-xl font-serif'>{data.title}</h4>
                            <p className='my-2 text-white text-lg font-medium'>{data.salary}</p>
